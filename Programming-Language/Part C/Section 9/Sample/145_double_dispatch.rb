...
# * a method name, multiple argument-lists, multiple return values
# * Use dynamic dispatch to call the correct method
#
# Ruby never allows methods with the same name
# Java/C#/C++ do not have multimethods, they have static overloading
...
class Add < Exp
  ...
  def eval
    e1.eval.add_values e2.eval # send a message
  end
  def toString
