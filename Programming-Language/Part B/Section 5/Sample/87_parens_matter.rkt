...
; Racket with a simple syntax
; * Terms:
;   - atom: #t, #f, 33, "hi", null, 5.0, x, ...
;   - special form: define, lambda, if, Macros..
;   - sequences: (t1 t2 ... tn)
; * Brackets:
;   - can use [] or {}
;   - converting the tree into a program (code generation)
;      - Atoms are leaves
;      - sequences are nodes with elemets as children
;   - makes indentation easy

#lang racket

(provide (all-defined-out))

; NOTE: PARENTHESES MATTERS!
; In most places (e) means call e with zero arguments
; ((e)) means call e with 0 arguments and call the result with 0 arguments
